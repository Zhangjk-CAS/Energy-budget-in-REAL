...
!YU   real,dimension(:),allocatable:: dyr_global
      ...
      integer :: ix,iy
      real(r8),dimension(:,:),allocatable:: vit_global,viv_global
!      real(r8),dimension(:,:,:),allocatable:: vit_global,viv_global
...
!lhl20150715
      integer,dimension(imt,jmt):: iunu
!lhl20150715
!lhl1204
...
!zhangjk 20250528
      real(r8),dimension(s_imt_ro):: s_lon_ro
      real(r8),dimension(s_jmt_ro):: s_lat_ro 
!lhl090729
...
! DFS 2024
!
      INTEGER :: NUMBER,NSTART,IY0,IYFM,MON0,MEND,IMD,IDAY,II,JJ,IO_HIST,IO_REST,rest_freq,hist_freq
      integer :: klv
!
