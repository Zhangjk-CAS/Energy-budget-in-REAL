...
number_var = 0
for item in ['ape-era-glorys-nwp.nc']:#,'ape-jra-glorys-nwp.nc','ape-jra-licom3-nwp.nc']:ape-era-glorys-nwp.nc
    ...
    var[var == 0] = np.nan 
    # var[var > 20] = 0.0  
    print(f'the max is {np.nanmax(var)}')
