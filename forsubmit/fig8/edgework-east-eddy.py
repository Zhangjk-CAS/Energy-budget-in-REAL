...
terms = [('edge3uaemke-era-glorys', 
          'edge3uaemke-jra-glorys', 
          'edge3uaemke-jra-licom3', 
          'edgeuaemke-glorys', 
          'data-licom3high/edgeuaemke-licom3Global'),
              
         ('edge2rhoaaa-era-glorys', 
          'edge2rhoaaa-jra-glorys', 
          'edge2rhoaaa-jra-licom3', 
          'edge2rhoaaa-glorys', 
          'data-licom3high/edgerhoaaa-licom3Global')] # for mke 
...
# axs[1,1].plot(lat, vare_itg+999, color=colors[0], linewidth=0.9, linestyle='-', label=ln[0])
# axs[1,1].plot(lat, vare_itg+999, color=colors[1], linewidth=0.9, linestyle='-', label=ln[1])
# axs[1,1].plot(lat, vare_itg+999, color=colors[2], linewidth=0.9, linestyle='-', label=ln[2])
# axs[1,1].plot(lat, vare_itg+999, color=colors[3], linewidth=0.9, linestyle='--', label=ln[3])
# axs[1,1].plot(lat, vare_itg+999, color=colors[4], linewidth=0.9, linestyle='--', label=ln[4])
# axs[1,1].legend(loc='lower left', ncol=2, frameon=False, fontsize=6)
...
axs[0].set_ylabel('×10⁵W/m')
axs[1].set_ylabel('×10⁵W/m')

pnstr2 = f'edgework-itg-eddy'
