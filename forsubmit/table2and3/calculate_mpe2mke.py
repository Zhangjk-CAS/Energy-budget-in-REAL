...
key_strs = ['ww-2014-2018']
vn = 'ww'
vn2= 'rho'
# vn3= 'rho'

pnstrs = [f'mpe2mke-eg-daily']
...
for nforce in range(1):
    ...
    dswm = xr.open_dataset(path + 'ww-2014-2018.nc', decode_times=False)
    ...
    for item in sorted(os.listdir(nowdir)):
        ...
        if any(key in item for key in key_strs):
            ...
            if number_day == 0:
                ...
                p2e = p2e - g * varrho * varw * [1,1,1]

            print(p2e.shape)

            print([np.nansum(p2e[number_day, 0, :])])
