...
!-------------------------------------------------------------------------------
      ...
      integer,parameter:: jstart    = 1     ! Satrting grid for Tracer in Latitude.
!      integer,parameter:: imt_global=1872   ! Number of Grid Points in Longitude
!
!   The following line is added by DFS in 2018-09
!
      integer,parameter:: imt_global=551   ! Number of Grid Points in Longitude
!
!         DFS in 2018-09
!
      integer,parameter:: km=55     ! Number of Grid Points in Vertical Direction
#ifdef SPMD
...
!      integer,parameter:: jet=(jmt_global-jst_global+1-num_overlap)/ny_proc+1+num_overlap
      integer,parameter:: jet=(jmt_global-jst_global+1-num_overlap)/ny_proc+num_overlap
!
!       DFS 
!
...
!lhl090729
      integer,parameter:: s_imt=1440,s_jmt=721,s_imt_ro=551,s_jmt_ro=641
!lhl090729

!zhangjk 20250418
      integer,parameter:: the_first_year = 2013
!
