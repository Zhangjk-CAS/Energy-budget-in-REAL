...
!
    ...
    real(r8), dimension(imt,jmt) :: sst_skin
    real(r8), dimension(imt,jmt) :: wrm_sflx_old, wrm_eflx_old, wrm_tauw_old
    real(r8), dimension(imt,jmt) :: wrm_rf_old
    real(r8), dimension(imt,jmt) :: wrm_qcol_ac, wrm_tauw_ac
#endif

#if ( defined SWF_DIURNAL )
    real(r8), allocatable,dimension(:,:,:) :: swv_new
#endif

#if ( defined TOGA_COARE_FLUX || defined SWF_DIURNAL )
    real(r8), dimension(imt) :: fflon_loc
    real(r8), dimension(jmt) :: fflat_loc
#endif
!
! DFS 2024-07
!
