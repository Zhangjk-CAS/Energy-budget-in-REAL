...
!
      ...
      call exchange_3d(DLU,km,1,1)
      call exchange_3d(DLV,km,1,1)
#endif
...
!$OMP PARALLEL DO PRIVATE(j,k)
     do k = 1, kmm1
     do j = jst, jmt
         rict(1,j,k) = rict(2,j,k)
         rict(imt,j,k) = rict(imm,j,k)
     end do
     end do
     end if
#else
...
#ifdef SPMD
      call exchange_3d(rict,kmm1,1,1)
#endif
#ifdef DEBUG
...
!lhl0711#ifdef SPMD
!lhl0711      call exchange_3d(PDENSITY,km)
!lhl0711#endif
...
!lhl1204
      ...
      END DO
!lhl0711#ifdef SPMD
!lhl0711      call exchange_3d(PP,km)
!lhl0711      call exchange_3d(PPA,km)
!lhl0711      call exchange_3d(PPB,km)
!lhl0711      call exchange_3d(PPC,km)
!lhl0711#endif
#ifdef DEBUG
...
!
!lhl0711#ifdef SPMD
!lhl0711      call exchange_3d(ALPHA,km)
!lhl0711      call exchange_3d(BETA,km)
!lhl0711#endif
#ifdef DEBUG
...
!$OMP PARALLEL DO PRIVATE (J,I)
      ...
      END DO
!lhl0711#ifdef SPMD
!lhl0711      call exchange_2d(BUOYTUR)
!lhl0711      call exchange_2d(BUOYSOL)
!lhl0711#endif
#ifdef DEBUG
...
!                                     -1000.D0*(AT(I,J,K,2)-AT(I,J,K+1,2))*BETA(I,J,K+1))*ODZT(K+1)
      ...
      END DO
!lhl0711#ifdef SPMD
!lhl0711      call exchange_3d(ricdt,kmm1)
!lhl0711!      call exchange_3d(rict,kmm1)
!lhl0711#endif
#ifdef DEBUG
...
#ifdef  SPMD                                                   
       call exchange_2d(WGP,1,1)                       
       call exchange_2d(WHX,1,1)                       
       call exchange_2d(WHY,1,1)                       
#endif  
