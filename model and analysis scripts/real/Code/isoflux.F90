...
!
      ...
      END DO
#ifdef SPMD
      call exchange_3d(work_1,km,1,1)
      call exchange_3d(ddy_iso(1,1,1,m),km,1,1)
#endif
...
!
      ...
      END DO
#ifdef SPMD
       call exchange_3d(dx_iso(1,1,1,m),km,1,1)
       call exchange_3d(dy_iso(1,1,1,m),km,1,1)
       call exchange_3d(dz_iso(1,1,1,m),km,1,1)
#endif
...
!
      ...
      END DO
#ifdef SPMD 
      call exchange_3d(aay_iso(1,1,1,m),km,1,1)
#endif
...
!PY      end if
      ...
      call exchange_3d(work_1,km,0,1)
#else
...
!
      ...
      END DO
#ifdef SPMD
       call exchange_3d(ax_iso(1,1,1,m),km,1,1)
       call exchange_3d(ay_iso(1,1,1,m),km,1,1)
       call exchange_3d(az_iso(1,1,1,m),km,1,1)
#endif
