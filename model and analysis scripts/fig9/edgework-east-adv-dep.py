...
# axs[0].plot(lat, vare_itg+999, color=colors[0], linewidth=0.9, linestyle='-', label=ln[0])
# axs[0].plot(lat, vare_itg+999, color=colors[1], linewidth=0.9, linestyle='-', label=ln[1])
# axs[0].plot(lat, vare_itg+999, color=colors[2], linewidth=0.9, linestyle='-', label=ln[2])
# axs[0].plot(lat, vare_itg+999, color=colors[3], linewidth=0.9, linestyle='--', label=ln[3])
# axs[0].plot(lat, vare_itg+999, color=colors[4], linewidth=0.9, linestyle='--', label=ln[4])
# axs[0].legend(loc='lower left', ncol=2, frameon=False, fontsize=10)
